...
<div class="mt-8 w-full text-center flex flex-col text-neutral-500">
  ...
  <a href="/d-tierlist/d21" class="block my-1 p-1 text-5xl font-extrabold text-off-white bg-cerise-strong text-center after:content-['D-22_TIER_LIST'] hover:after:content-['ÄLDRE_ÅRSKURS?'] hover:bg-off-yellow hover:text-off-black transition-colors"></a>
